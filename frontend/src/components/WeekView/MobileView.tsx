...
export function MobileView({
  ...
  // Fetch current week events for drag and drop hook
  ...
  const { activeBlock, handleDragStart, handleDragEnd, sensors } = useMobileDragAndDrop(currentBlocks, {
    updateEventTime,
    moveEvent,
  });
    ...
    <DndContext sensors={sensors} onDragStart={handleDragStart} onDragEnd={handleDragEnd}>
      ...
      >
        {({ weekDays, blocks, isLoading }) => {
          const weekNumber = getWeekNumber(weekDays[0] || selectedDate);
              ...
              <header className="flex flex-col gap-2 p-4 border-b border-[var(--color-bg-tertiary)]">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    >
                      {formatWeekHeader(weekDays[0] || selectedDate)}
                    </h1>
